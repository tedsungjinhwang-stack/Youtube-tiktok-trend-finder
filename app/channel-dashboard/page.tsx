...
type Platform = 'YOUTUBE' | 'TIKTOK' | 'INSTAGRAM' | 'THREADS' | 'NAVER_CLIP';
...
const PLATFORM_ORDER: Platform[] = ['YOUTUBE', 'TIKTOK', 'INSTAGRAM', 'THREADS', 'NAVER_CLIP'];
  ...
  return (
    <div className="mx-auto max-w-[1180px] px-5 pb-16 pt-6">
      ...
      <div className="mb-4 flex flex-wrap items-end justify-between gap-5">
        <div>
          <h1 className="text-[26px] font-extrabold tracking-[-0.03em]">채널 대시보드</h1>
          <p className="mt-1.5 text-[13px] font-semibold text-muted-foreground">
            YouTube · TikTok · Instagram · Threads · 네이버클립 — 채널별 마지막 발행 예약
          </p>
        </div>
